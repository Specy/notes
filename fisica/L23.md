...
> [!note] Lezione di chiusura
> È l'ultima lezione del corso: non ci sono argomenti nuovi, ma esercizi che richiamano cinematica dei gas, primo e secondo principio, entropia. Diverse lavagne sono molto cancellate; dove i passaggi non erano leggibili, ho ricostruito il metodo e riportato i risultati chiave.
...
Nell'**espansione libera** (recipiente isolato, vedi [[L18]]) non c'è scambio di calore con l'esterno, quindi $\Delta S_{ambiente} = 0$ e tutta la variazione è del sistema:

$$\Delta S_{universo} = \Delta S_{sistema}$$

Poiché l'entropia è funzione di stato (vedi [[L22]]), la si calcola lungo un percorso reversibile tra gli stessi stati. Il volume a disposizione di ciascun gas aumenta, e applicando $\Delta S = nC_V\ln\frac{T_f}{T_0} + nR\ln\frac{V_f}{V_0}$ per i due gas si ottiene
...
Sull'adiabatica vale $PV^\gamma = \text{cost}$ (vedi [[L19]]), da cui
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------- | ---------------- | --- | --- |
| Equazione di stato | $PV = nRT$                                                                                                          | [[L17]]          |     |     |
| Primo principio    | $\Delta U = Q - L$, $\Delta U = nC_V\Delta T$                                                                       | [[L18]]          |     |     |
| Mayer              | $C_P = C_V + R$, $\gamma = C_P/C_V$                                                                                 | [[L18]]          |     |     |
| Lavoro             | $L = \int P\,dV$ (area in $P$–$V$)                                                                                  | [[L16]]          |     |     |
| Adiabatica         | $PV^\gamma = \text{cost}$                                                                                           | [[L19]]          |     |     |
| Rendimento         | $\eta = 1 - \dfrac{                                          \mid Q_{ced} \mid }{Q_{ass}} \le 1 - \dfrac{T_1}{T_2}$ | [[L19]], [[L22]] |     |     |
| Secondo principio  | $\Delta S_{universo} \ge 0$                                                                                         | [[L22]]          |     |     |
| Entropia (gas)     | $\Delta S = nC_V\ln\dfrac{T_B}{T_A} + nR\ln\dfrac{V_B}{V_A}$                                                        | [[L22]]          |     |     |
...
📎 Lezione precedente: [[L22]] · 🎓 Fine del corso
