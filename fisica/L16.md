...
<svg viewBox="0 0 180 140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Isoterme di Boyle: iperboli nel piano P-V a temperature crescenti">
  <line x1="30" y1="120" x2="170" y2="120" stroke="currentColor" stroke-width="1.2"/>
  <polygon points="170,120 162,116 162,124" fill="currentColor"/>
  <line x1="30" y1="120" x2="30" y2="15" stroke="currentColor" stroke-width="1.2"/>
  <polygon points="30,15 26,23 34,23" fill="currentColor"/>
  <path d="M 40 110 Q 70 45 150 35" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <path d="M 50 115 Q 85 60 160 48" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <g fill="currentColor" font-size="10" font-family="serif">
    <text x="22" y="20">P</text><text x="165" y="133">V</text>
    <text x="150" y="30" font-style="italic">T↑</text>
  </g>
</svg>
