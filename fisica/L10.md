...
> [!info] Avviso
> **1° parziale:** giovedì 23 aprile, ore 8:30–11:30. Iscrizione obbligatoria sulla segreteria virtuale (ESSE3).
...
> In aula compare "$13{,}5\ \text{kJ}$", ma $135\,000\ \text{J} = 135\ \text{kJ}$ (refuso di un fattore 10). La conversione successiva è coerente con $135\ \text{kJ}$: $135\,000/4184 \approx 32 \approx 30\ \text{kcal}$.
