...
Consideriamo una massa $m$ attaccata a una molla orizzontale, libera di oscillare. Scegliamo l'origine $O$ nella **posizione di equilibrio** (molla a riposo): così la forza elastica è semplicemente $F = -kx$ (vedi [[10-potenza-energia-spesa-e-forza-elastica]]).
